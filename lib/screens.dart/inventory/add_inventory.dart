          ...
          child: Padding(
            ...
            child:
                ...
                children: [
                  Expanded(
                      child: SearchDropDownMenu<Product>(
                          ...
                          controller: product,
                          onSelected: (val) {
                            print("that product is sleceted");
              ...
              MyTextFieldWithTitle(
                  name: "Quantity to Add", label: "", controller: quantity),
              const SizedBox(height: 24),
              MyTextFieldWithTitle(
                name: "Select Date",
                label: "",
              ...
              CustomButton(
                ...
                ontap: () async {
                  Stock purchase = Stock(
                      ...
                      minimumRequiredQuantity: int.parse(quantity.text),
                    );
                 print(purchase);
                  ref.read(inventoryProvider.notifier).addInventory(purchase);
                },
              )
            ]),
          ),
